...
class LandmarkMainViewController: BaseMainViewController {
    ...
    override func viewDidLoad() {
        ...
        // 新竹景點資料 ID
        self.strTargetID = "https://www.twtainan.net/opendata/attractionapi?category=0&township=0&type=JSON"//=======================//
        //7ea7e303-df62-4fbe-a84f-99bdd724b577/resource/c15a9c5f-f6cb-4da5-b8a6-5e7bc4c9eb08/download/20180501160733080.json
